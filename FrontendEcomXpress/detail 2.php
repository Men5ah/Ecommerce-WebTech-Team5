            ...
            <div class="row px-xl-5">
                    ...
                    <div id="product-carousel" class="carousel slide" data-ride="carousel">
                        <div class="carousel-inner bg-light">
                            <div class="carousel-item active">
                                <img class="w-100 h-100" src="img/iron.jpeg" alt="Image">
                            </div>
                        </div>
                ...
                <div class="col-lg-7 h-auto mb-30">
                    <div class="h-100 bg-light p-30">
                        ...
                        <h3 class="font-weight-semi-bold mb-4">GhC180.00</h3>
                        <p class="mb-4">The best solution to clothe wrinkles!</p>
                        <div class="d-flex mb-3">
                    ...
                    <div class="bg-light p-30">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="tab-pane-1">
                                ...
                                <p>Introducing our premium iron for all your garment care needs! Designed with cutting-edge technology, our iron ensures effortless and efficient ironing every time.</p>
                            </div>
                            <div class="tab-pane fade" id="tab-pane-2">
                                <h4 class="mb-3">Additional Information</h4>
                                <p>Its sleek and ergonomic design makes it comfortable to hold and maneuver, while its powerful steam function effortlessly removes wrinkles and creases from fabrics, leaving them looking fresh and crisp.</p>
                                <div class="row">
                                    <div class="col-md-6">
                                        <ul class="list-group list-group-flush">
                                            <li class="list-group-item px-0">
                                                With customizable temperature settings and a durable non-stick soleplate, our iron is suitable for a wide range of fabrics, from delicate silks to sturdy denims.
                                            </li>
                                            <li class="list-group-item px-0">
                                                Say goodbye to stubborn wrinkles
                                            </li>
                                            <!-- <li class="list-group-item px-0">
                                                Adjustable straps for a comfortable fit
                                            </li> -->
                                            <li class="list-group-item px-0">
                                                Say hello to perfectly pressed garments with our reliable and versatile iron.
                                            </li>
                                          </ul> 
                                    </div>
                                    <div class="col-md-6">
                            ...
                            <div class="tab-pane fade" id="tab-pane-3">
                                <div class="row">
                                    <div class="col-md-6">
                                        <h4 class="mb-4">1 review for "Iron"</h4>
                    ...
                    <div class="owl-carousel related-carousel">
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="img/headphone.jpeg" alt="">
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="">Headphone</a>
                        ...
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="img/blender.jpeg" alt="">
                                <div class="product-action">
                                    <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                                    <a class="btn btn-outline-dark btn-square" href=""><i class="far fa-heart"></i></a>
                                    <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-sync-alt"></i></a>
                            ...
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="">Blender</a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>GHC70.00</h5><h6 class="text-muted ml-2"><del>GHC70.00</del></h6>
                                </div>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-primary mr-1"></small>
                                    <small class="fa fa-star text-primary mr-1"></small>
                        ...
                        <div class="product-item bg-light">
                            ...
                            <div class="text-center py-4">
                                ...
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>GHC15.00</h5><h6 class="text-muted ml-2"><del>GHC15.00</del></h6>
                                </div>
                                <div class="d-flex align-items-center justify-content-center mb-1">
                                    <small class="fa fa-star text-primary mr-1"></small>
                                    <small class="fa fa-star text-primary mr-1"></small>
