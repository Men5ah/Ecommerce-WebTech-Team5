        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="img/highlighters.jpeg" alt="Image">
                        </div>
                    </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h3 class="font-weight-semi-bold mb-4">GHC20.00</h3>
                    <p class="mb-4">Your study pal!</p>
                    <div class="d-flex mb-3">
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="mb-4">1 review for "highlighters"</h4>
                                    <div class="media mb-4">
                                        <img src="img/user.jpg" alt="Image" class="img-fluid mr-3 mt-1" style="width: 45px;">
                                        <div class="media-body">
                                            <h6>Yaa Mansah<small> - <i>01 Jan 2025</i></small></h6>
                ...
                <div class="owl-carousel related-carousel">
                    <div class="product-item bg-light">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">Brown Quilt bag</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>GHC180.00</h5><h6 class="text-muted ml-2"><del>GHC180.00</del></h6>
                            </div>
                    ...
                    <div class="product-item bg-light">
                        ...
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="">Maths set</a>
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>GHC30.00</h5><h6 class="text-muted ml-2"><del>GHC30.00</del></h6>
                            </div>
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                <small class="fa fa-star text-primary mr-1"></small>
                                <small class="fa fa-star text-primary mr-1"></small>
                    ...
                    <div class="product-item bg-light">
                        ...
                        <div class="text-center py-4">
                            ...
                            <div class="d-flex align-items-center justify-content-center mt-2">
                                <h5>GHC2.00</h5><h6 class="text-muted ml-2"><del>GHC2.00</del></h6>
                            </div>
                            <div class="d-flex align-items-center justify-content-center mb-1">
                                <small class="fa fa-star text-primary mr-1"></small>
                                <small class="fa fa-star text-primary mr-1"></small>
