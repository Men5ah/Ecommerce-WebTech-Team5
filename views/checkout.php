                    ...
                    <div class="bg-light p-30 mb-5">
                        <div class="row">
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" type="text" name="" placeholder="John">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Last Name</label>
                                <input class="form-control" type="text" name="" placeholder="Doe">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>E-mail</label>
                                <input class="form-control" type="text" name="" placeholder="example@email.com">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Mobile No</label>
                                <input class="form-control" type="text" name="" placeholder="+123 456 789">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>Address Line 1</label>
                                <input class="form-control" type="text" name="" placeholder="123 Street">
                            </div>
                            <div class="col-md-6 form-group">
                            ...
                            <div class="col-md-6 form-group">
                                <label>City</label>
                                <input class="form-control" type="text" name="" placeholder="New York">
                            </div>
                            <div class="col-md-6 form-group">
                                <label>State</label>
                                <input class="form-control" type="text" name="" placeholder="New York">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <input class="form-control" type="text" name="" placeholder="123">
                            </div>
                    ...
                    <div class="collapse mb-5" id="shipping-address">
                        ...
                        <div class="bg-light p-30">
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>Mobile No</label>
                                    <input class="form-control" type="text" name="billing_mobile_no" placeholder="+123 456 789">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Address Line 1</label>
                                    <input class="form-control" type="text" name="billing_address_line1" placeholder="123 Street">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Address Line 2</label>
                                    <input class="form-control" type="text" name="billing_address_line2" placeholder="123 Street">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label>Country</label>
                                    <select class="custom-select">
                                ...
                                <div class="col-md-6 form-group">
                                    <label>ZIP Code</label>
                                    <input class="form-control" type="text" name="billing_zip_code" placeholder="123">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="bg-light p-30">
                                ...
                                <!-- Add hidden fields for other information -->
                                <!-- <input type="hidden" name="user_id" value="123"> Replace with actual user_id -->
                                <!-- <input type="hidden" name="total_amount" value="100.00"> Replace with actual total_amount -->
                                <!-- <input type="hidden" name="status" value="Pending"> Replace with actual status -->
                                <!-- <input type="hidden" name="payment_method" value=""> This will be filled using JavaScript based on the selected payment option -->
                                <!-- <input type="hidden" name="shipping_address" value="123 Shipping St"> Replace with actual shipping address -->
